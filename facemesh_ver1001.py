...
Face_line_index2 = [334, 650, 651, 652, 653, 654, 655, 656, 387, 657, 658, 659, 660, 661, 663, 351, 662, 349,
                    2,1,346,7, 347, 345, 344, 343,342,341,42, 340, 339, 338, 337,336,335,333]

Combine_index = [(870,10), (869,284), (869,260), (869,278), (869,248),
                (869,218), (869,335), (869,302), (578,394), (868,271),
                (868,307),(868,252), (868,343),(868,311),(868,325),
                (868,324),(868,346),(868,323),(868,125),

                (1185,121),(1184,149),(1183,122),(1182,123),
                (1181,109),(1180,145),(1179,49),(1178,105),
                (1177,68),(907,201),(1175,100),(1174,135),
                (1173,15),(1172,45),(1171,76),(1170,57),(1169,82)]
...
class createFaceMesh:
    ...
    def import_head(self):
        ...
        bpy.ops.import_scene.obj(filepath="./static/headpart3.obj")
    ...
    def resize_head(self, landmarks_point):
        ...
        print(h_length_x / v_length_x, h_length_y / v_length_y, h_length_z / v_length_z)
        ...
        bpy.data.objects['headpart'].scale = (v_length_x / h_length_x, v_length_z / h_length_z, v_length_y / h_length_y)

    def combine_head(self):

        self.chooes_object('headpart')
        obj = bpy.context.active_object
        list = [(obj.matrix_world @ v.co) for v in obj.data.vertices]

        headpart_cursor = list[Face_line_index2[18]]

        # 뒤통수
        bpy.context.scene.cursor.location = (headpart_cursor[0], headpart_cursor[1], headpart_cursor[2])
        ...
        visage_cursor = list[Face_line_index1[18]]

        bpy.context.scene.cursor.location = (visage_cursor[0],visage_cursor[1],visage_cursor[2])
        bpy.ops.object.origin_set(type='ORIGIN_CURSOR', center='MEDIAN')
        bpy.context.object.location = (0, 0, 0)
    ...
    def export_bpy(self, filename, save_dir):
        ...
        bpy.ops.wm.save_as_mainfile(filepath=save_dir+filename+".blend")
        print("export : ", save_dir+filename+".fbx" )
    #도형 생성(점)
    ...
    def rotation_axis(self, object_name):
        ...
        obj = bpy.data.objects['Visage']
        list = [(obj.matrix_world @ v.co) for v in obj.data.vertices]
        # diff_x = list[10][0] - list[152][0]
        # diff_y = list[10][1] - list[152][1]
        # diff_z = list[10][2] - list[152][2]
        # print("!!!!!!!!!!!!!!",diff_x, diff_y, diff_z)
        print(list[10], list[152])
