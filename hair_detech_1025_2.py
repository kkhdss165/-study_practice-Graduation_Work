        ...
        for (root, directories, files) in os.walk(self.dir_path):
            for file in files:
                if '.png' in file:
                    ...
                    print("MSE: ", mse(compare_img, choose_img))
                    print("RMSE: ", rmse(compare_img, choose_img))
                    print("PSNR: ", psnr(compare_img, choose_img))
                    print("SSIM: ", ssim(compare_img, choose_img))
                    print("UQI: ", uqi(compare_img, choose_img))
                    print("MSSSIM: ", msssim(compare_img, choose_img))
                    print("ERGAS: ", ergas(compare_img, choose_img))
                    print("SCC: ", scc(compare_img, choose_img))
                    print("RASE: ", rase(compare_img, choose_img))
                    print("SAM: ", sam(compare_img, choose_img))
                    print("VIF: ", vifp(compare_img, choose_img))

                    cv2.destroyAllWindows()
                    cv2.imshow("compare_img", compare_img)
                    cv2.imshow("choose_img", choose_img)
                    cv2.waitKey(0)
