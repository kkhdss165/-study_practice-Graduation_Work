...
class createFaceMesh:
    ...
    def resize_hair(self):
        if self.expansion_ratio != None:
            bpy.data.objects['hairpart'].scale = self.expansion_ratio

    #test
    def import_hair(self):
        bpy.ops.import_scene.obj(filepath="./static/hair/crew_hair.obj")
        for obj in bpy.context.selected_objects:
            obj.name = "hairpart"
    ...
    def createMesh(self, save_dir):
        ...
        self.export_bpy('new4',save_dir)


if __name__ == '__main__':
    # createFaceMesh('./img/hyunbin.png')
    createFaceMesh('./img/jungmin.png')