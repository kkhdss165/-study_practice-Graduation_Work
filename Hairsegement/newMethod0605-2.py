...
file_names =[ '../img/sukhun.png','../img/longhair.jpg', '../img/actor.jpg','../img/hyunbin.png', '../img/jungmin.png', '../img/sangsoo.png', '../img/sukhun.png',  '../img/longhair.jpg']
    ...
    for now_index in range(len(combine_list)):
        ...
        if len(combine_list[now_index]) != 0:
                    ...
                    if (y_index,x_index) not in combine_list[now_index]:
                        ...
                        if compare_color not in [center[0]]:
                            ...
                            for idx in range(len(combine_list)):
                                if (y_index,x_index) in combine_list[idx]:
                                    near_index = idx
                                    if idx not in near_group_list:
                                        near_group_list.append(idx)
                                        near_group_color.append(compare_color)
            ...
            for near_color in near_group_color:
                diff = (near_color[0]-now_color[0])**2 + (near_color[1]-now_color[1])**2 + (near_color[2]-now_color[2])**2
